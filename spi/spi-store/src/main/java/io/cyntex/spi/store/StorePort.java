 ...
 * the connection catalog, the discovered source-schema store, and the connector distribution registry.
 * A pure interface over the core ring only (rule R2); a store backend (a database adapter) implements
